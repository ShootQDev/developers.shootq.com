...
General workflow:
  ...
  * All API URLs have the following prefix: `https://home.shootq.com/api/v1/`
...
<aside class="alert">
   In a previous version of this document the domain name for the API
   endpoint was <b>api</b>.shootq.com.  This has changed to
   <b>home</b>.shootq.com.  Please update your scripts.
</aside>
...
```shell
curl "https://home.shootq.com/api/v1/contactform/contactformtemplate/<form_template_id>/view/"
```
...
$(function($) {
    ...
    var config = {
        api_root: 'https://home.shootq.com/api/v1/'
    };
